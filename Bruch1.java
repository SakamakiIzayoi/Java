...
public class Bruch {
    ...
    ///zeigt an wieviele Bruch objekte erstellt wurden
     ...
     */
    Bruch(){
        this(0,1); ///ruft den Konstruktor Bruch (int z, int n) auf (siehe unten)
    }
     ...
     */
    Bruch(int nenner){
        this(1, nenner); ///ruft den Konstruktor Bruch (int z, int n) auf (siehe unten)
    }
     ...
     */
    Bruch (int z, int n){
        setze(z,n); /// ruft die Methode(z,n) auf um die Werte zu setzen
       /// erhöht die Klassen Variable vom Objekt aus, so das wir zählen können wie viele Objekte erstellt wurden
        anzahlBrueche++;
    }
     ...
     * @param n
     */
    void setze(int z, int n){  // Methode weißt zaehler und Nenner jeweils z und n zu
